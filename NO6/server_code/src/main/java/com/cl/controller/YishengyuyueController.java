    ...
    public R update(@RequestBody Long[] ids, @RequestParam String sfsh, @RequestParam String shhf){
        ...
        for(Long id : ids) {
            ...
            if("已通过".equals(sfsh)) {
                ...
                // 设置通知编号（可以使用时间戳+随机数）
                String tongzhibianhao = "T" + System.currentTimeMillis() + (int)(Math.random() * 1000);
                ...
                tongzhi.setTongzhibeizhu("您的预约已通过，就诊时间：" + yishengyuyue.getYuyueshijian());
                // 初始发送状态为待发送
                tongzhi.setFsshuangtai("待发送");
                // 初始重试次数为0
                ...
                // 立即发送通知
                jiuzhentongzhiService.sendNotification(tongzhi.getId());
            }
        }
