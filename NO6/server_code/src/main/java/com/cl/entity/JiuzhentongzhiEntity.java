...
public class JiuzhentongzhiEntity<T> implements Serializable {
	 ...
	 * 设置：发送状态
	 */
	public void setFsshuangtai(String fsshuangtai) {
		this.fsshuangtai = fsshuangtai;
	}
	/**
	 * 获取：发送状态
	 */
	public String getFsshuangtai() {
		return fsshuangtai;
	}
	/**
	 * 设置：重试次数
	 ...
	 * 设置：最后发送时间
	 */
	public void setZuihoushijian(Date zuihoushijian) {
		this.zuihoushijian = zuihoushijian;
	}
	/**
	 * 获取：最后发送时间
	 */
	public Date getZuihoushijian() {
		return zuihoushijian;
	}
	/**
	 * 设置：错误信息
	 */
